...
export const DEFAULT_FRONTEND_URL = 'https://quedamos.alvarotc.com';

/** Previous public host: links and installed APKs still point at it. */
export const LEGACY_FRONTEND_URL = 'https://quedamos-app-mobile.vercel.app';
