          ...
          <div className="w-[300px] p-2.5 rounded-[46px] bg-bg-surface border border-subtle">
            <div className="flex flex-col gap-3.5 p-4 rounded-[37px] bg-bg border border-subtle overflow-hidden">
              <div className="flex items-center justify-between">
                ...
                {/*
                  Mockup decorativo: en el artboard real esto es un toggle
                  Próximas/Pasadas, pero aquí no hay estado que alternar (no
                  llega a cambiar la lista de abajo), así que se pinta como
                  spans estáticos con "Próximas" fijo en activo en vez de
                  reutilizar <SegmentedPills> (que sí es interactivo en el
                  resto de la app) — un <button> que no hace nada añade dos
                  tab stops muertos que los lectores de pantalla anuncian.
                */}
                <div className="inline-flex border border-subtle rounded-pill p-0.5 gap-0.5">
                  <span className="px-3.5 py-1.5 rounded-pill text-xs bg-primary-solid text-on-primary font-bold">
                    {t('landing2.pantallas.events.upcoming')}
                  </span>
                  <span className="px-3.5 py-1.5 rounded-pill text-xs text-text-muted font-semibold">
                    {t('landing2.pantallas.events.past')}
                  </span>
                </div>
              </div>
              <div className="flex flex-col gap-2.5 p-3.5 rounded-lg bg-bg-light border border-subtle">
                ...
                <div className="flex items-center justify-between">
                  <span
                    ...
                    style={{
                      backgroundColor: 'var(--app-success-tint)',
              ...
              <div className="flex flex-col gap-2.5 p-3.5 rounded-lg border border-subtle">
                ...
                <span
                  ...
                  style={{
                    backgroundColor: 'var(--app-warning-tint)',
            ...
            <div className="flex flex-col gap-4 p-4 rounded-[37px] bg-bg border border-subtle overflow-hidden">
              ...
              <div className="flex items-center justify-between px-3.5 py-2.5 rounded-md border border-subtle">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-bold text-sm text-text">
                    {t('landing2.cuadrilla.names.vera')}
                  </span>
                </div>
                <span className="font-mono text-[11px] text-text-muted">
              ...
              <div className="flex items-center justify-between px-3.5 py-2.5 rounded-md border border-subtle">
                <div className="flex items-center gap-2.5">
                  ...
                  />
                  <span className="font-bold text-sm text-text">
                    {t('landing2.cuadrilla.names.iris')}
                  </span>
                </div>
                <span className="font-mono text-[11px] text-text-muted">
