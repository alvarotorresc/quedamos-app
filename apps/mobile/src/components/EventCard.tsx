        ...
        <div className="flex gap-2 mt-3">
          {onConfirm && isPastEvent === false && event.status === 'pending' && (
            <button
              ...
              className="flex-1 py-2 rounded-btn text-xs font-semibold transition-colors border-none inline-flex items-center justify-center gap-1.5 bg-success/10 text-success"
          ...
          {onDelete && (
            <button
              ...
              disabled={isDeleting}
              className="flex-1 py-2 rounded-btn text-xs font-semibold transition-colors border-none inline-flex items-center justify-center gap-1.5 bg-error/10 text-error"
